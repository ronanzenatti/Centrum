...
@section('content_header')
    <h1 class="text-bold">Editar Docente</h1>
@stop

@section('content')
    <div class="callout callout-warning">
        <form id="cadastroDocente" role="form" action="{{ route('docentes.update',$user->id) }}" method="post"
                ...
                <div class="row">
                    <div class="col-sm-3" style="max-width: 310px !important;">
                        ...
                        <img class="profile-img" id="preview"
                             @if(empty($user->foto))src="https://via.placeholder.com/300?text=Foto+de+Perfil" @endif
                             @if(!empty($user->foto))src="{{asset($user->foto)}}" @endif
                             alt="Profile">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-4">
                                ...
                                <input id="matricula" name="matricula" type="number" required
                                       ...
                                       placeholder="Número de Matricula" required
                                       value="{{ empty(old('matricula')) ? $user->matricula : old('matricula') }}">
                            ...
                            <div class="form-group offset-sm-5 col-sm-3 text-right">
                                ...
                                <input type="checkbox" class="bootstrapSwitch" name="admin" id="admin"
                                    {{($user->admin || old('admin')) ? 'checked' : null}}>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-12">
                                ...
                                <input id="email" name="email" type="email"
                                       ...
                                       placeholder="E-mail Institucional" required readonly
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <input id="lattes" name="lattes" type="text"
                               ...
                               value="{{ empty(old('lattes')) ? $user->lattes : old('lattes') }}">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input id="site" name="site" type="text"
                               ...
                               placeholder="Link para o Site Particular"
                               value="{{ empty(old('site')) ? $user->site : old('site') }}">
                        @if($errors->has('site'))
                            <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        ...
                        <textarea name="biografia" id="biografia"
                                  class="form-control summernote">{{ empty(old('biografia')) ? $user->biografia : old('biografia') }}</textarea>
                    </div>
                </div>
            </div>
            <!-- /.card-body -->
            ...
            <div class="card-footer text-center">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <button type="submit" class="btn btn-warning btn-lg float-right">SALVAR</button>
                    </div>
                </div>
            </div>
        </form>
...
@section('js')
    <script>
        ...
        }, "Entre com um e-mail institucional @cps.sp.gov.br ou @etec.sp.gov.br");
