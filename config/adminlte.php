        ...
        [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => '//cdnjs.cloudflare.com/ajax/libs/pace/1.0.2/themes/red/pace-theme-bounce.min.css',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
        ...
        [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdn.jsdelivr.net/npm/summernote@0.8.18/dist/lang/summernote-pt-BR.min.js'
                ],
                [
                    'type' => 'css',
                    'asset' => false,
        ...
        [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdn.jsdelivr.net/npm/jquery-validation@1.19.2/dist/additional-methods.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '/js/jquery-validate-pt-br.js',
                ],
            ],
        ],
